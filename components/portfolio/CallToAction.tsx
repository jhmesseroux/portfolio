...
const CallToAction = () => {
  return (
    <div className='my-8 p-4 '>
      <div className='relative bg-gradient dark:bg-red-300d shadow-1 dark:shadow-md flex items-start sm:items-center sm:gap-6 justify-between px-8 py-12 rounded flex-col  sm:flex-row gap-12'>
        ...
        <div className='flex items-center gap-4'>
          <LinkedIn
            icon={false}
            className='dark:bg-black/30 animate-pulse  dark:text-white dark:hover:bg-black/50 dark:border-none dark:hover:text-blue-400'
          />
          <a
