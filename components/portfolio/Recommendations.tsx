...
const Recommendations = ({ data, showAll = false }: { data: IReview[]; showAll: boolean }) => {
  useEffect(() => {
  ...
  return (
    <div className='my-8 p-4 ' id='recommendations'>
      ...
      >
        <div className='scroller__inner pauseable bg-violet-500/5 dark:bg-blue-900/10 my-6 '>
          <div className='flex items-center gap-8  p-4'>
            {data.map((review, i) => (
              <div key={i} className='w-[320px] bg-white dark:bg-slate-900 p-4 relative  rounded hover:bg-gradient'>
                  ...
                  <div className='socials flex  items-center gap-1'>
                    {review.author.linkedIn && (
                      <a
                        ...
                        target='_blank'
                        rel='noreferrer'
                        className='hover:bg-blue-400 hover:border-none text-blue-600 border-[0.2px] dark:border-slate-700 dark:text-blue-300 w-7 h-7 rounded-full hover:text-white flex items-center justify-center'
                      >
                    ...
                    {review.author.website && (
                      <a
                        ...
                        target='_blank'
                        rel='noreferrer'
                        className='hover:bg-violet-400 hover:border-none text-violet-600 border-[0.2px] dark:border-slate-700 dark:text-violet-400 w-7 h-7 rounded-full hover:text-white flex items-center justify-center'
                      >
